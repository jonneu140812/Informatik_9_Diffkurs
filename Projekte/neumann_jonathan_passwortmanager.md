...
1. Warum ist es unsicher, dasselbe Passwort bei mehreren Diensten zu verwenden?
    - Wird ein passwort öffendlich wie z.B. durch einen datenleck sind alle accounts verloren
1. Was kann bei einem Datenleck passieren?
    - Bei einem Datenleck können verscheidenste Daten Öffendlich werden, wie z.B. passworter, namen, etc.
...
1. Was ist zusätzlich zur Passwortverwaltung wichtig, zum Beispiel bei Zwei-Faktor-Authentifizierung oder Phishing?
